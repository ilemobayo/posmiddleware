...
public class SSLContextBuild {
    ...
    public static SSLContext getSSLContext(String cer) {
...
//        Security.addProvider(new BouncyCastleProvider());
        ...
        try {
            ...
            InputStream e = InputStream.nullInputStream();
...
//            ksKeys.setEntry("ca_root", trustedEntry, (KeyStore.ProtectionParameter)null);
    ...
    public static SSLContext getTLSContext(String cer) throws Exception {
        BufferedInputStream trustCertIS = null;
        TrustManager[] tm = null;
        trustCertIS = new BufferedInputStream(InputStream.nullInputStream());
